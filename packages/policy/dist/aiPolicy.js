 ...
 */
export function decideResponseMode(userMsg, assignment, submission) {
    ...
    const isOnAssignment = assignment.questions.some(question => msgLower.includes(question.toLowerCase()) ||
 ...
 */
export function isAskingForAnswer(userMsg) {
 ...
 */
export function hasGenuineAttempt(submission) {
...
export const DEFAULT_HINT_POLICY = {
 ...
 */
export function makeResponseDecision(context) {
